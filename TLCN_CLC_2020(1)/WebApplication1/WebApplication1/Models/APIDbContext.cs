...
namespace WebApplication1.Models
{
    ...
    public DbSet<WebApplication1.Models.MediaActor> MediaActor { get; set; }
    public DbSet<WebApplication1.Models.MediaDirector> MediaDirector { get; set; }
    public DbSet<WebApplication1.Models.MediaProductor> MediaProductor { get; set; }
    public DbSet<WebApplication1.Models.PhotoActor> PhotoActor { get; set; }
    public DbSet<WebApplication1.Models.PhotoDirector> PhotoDirector { get; set; }
